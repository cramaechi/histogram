//Program reads in an arbitrary amount of grades (0 - 5) from a class of students
//and documents the number of times a certain grade was made.
#include <iostream>
#include <cstdlib>
#include <cmath>
#include <iomanip>
...
//Precondition: All elements of the array gradeValues has been initialized to zero.
//arraySize >= 1.
